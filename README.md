...
matched against RapidMiner Naive Bayes model outputs
stored in a prediction table. Predicted disease, risk
level, and specialist recommendation returned in
real time. Phase 2 implements live REST API endpoint.
